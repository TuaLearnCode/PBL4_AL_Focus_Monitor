...
# Thêm đường dẫn để import các module trong cùng thư mục
sys.path.insert(0, os.path.dirname(__file__))

# --- Import các file code của bạn ---
import database
from login import LoginFrame # Import file login.py (chứa LoginFrame)
...
class MainApplication:
    ...
    def show_login_screen(self):
        ...
        self.current_frame = LoginFrame(self.root, on_login_success=self.on_login_success)
    ...
    def show_thongke(self):
        ...
        self.current_frame.pack(fill=tk.BOTH, expand=True)
        self.root.title("Hệ thống Giám sát ATT - Trang thống kê")
